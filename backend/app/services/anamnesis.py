...
RED_FLAG_PHRASES = {
    ...
    "gusi berdarah": "perdarahan gusi",
    "mimisan": "mimisan/perdarahan hidung",
    "darah": "perdarahan atau darah pada keluhan",
    "dehidrasi": "tanda dehidrasi",
    "sulit minum": "sulit minum atau dehidrasi",
    "lemas sekali": "lemas berat",
    "sangat lemas": "lemas berat",
    ...
    "kuning pada mata": "mata/kulit kuning",
    "kulit kuning": "mata/kulit kuning",
    "kuning pada kulit": "mata/kulit kuning",
    ...
    "tangan kaki dingin": "tangan/kaki dingin",
    "gelisah": "gelisah dengan kemungkinan perburukan",
...
CASE_HINTS = {
    ...
    "case_006": ["panas badan", "demam", "demam ringan", "tidak nyaman tubuh", "nyeri ringan", "meriang", "meriang ringan", "pusing", "pusing ringan", "sakit kepala", "sakit kepala ringan", "menggigil", "nyeri otot", "nyeri sendi", "pegal linu"],
...
SYMPTOM_CONCEPTS = {
    ...
    "berat badan turun": ["berat badan turun", "turun berat badan", "bb turun"],
    "keringat malam": ["keringat malam"],
    "mata/kulit kuning": ["mata kuning", "kulit kuning", "kuning pada mata", "kuning pada kulit"],
